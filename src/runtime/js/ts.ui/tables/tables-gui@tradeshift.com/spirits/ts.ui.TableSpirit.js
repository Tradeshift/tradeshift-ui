...
ts.ui.TableSpirit = (function using(Type, Client, guiArray, DOMPlugin, CSSPlugin, ConfigPlugin, Position, chained, confirmed, TableRowModel, ButtonSpirit, PagerModel) {
	...
	var ICON_ON = 'ts-icon-checkboxon';
	...
	/**
	 * TODO: Support that you don't have to match columns
	 * and cells length. Until that, verify that you do.
	 * @param {number} reflength
	 * @param {number} inlength
	 */
	function matchlength(reflength, inlength) {
		return true;
	}
